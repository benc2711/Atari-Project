...
void Game::Init()
{
    ...
    Shader myspriteShader = ResourceManager::GetShader("sprite");
    Renderer = new SpriteRenderer(myspriteShader);
    Particles = new ParticleGenerator(ResourceManager::GetShader("particle"), ResourceManager::GetTexture("particle"), 500);
    Shader myppShader = ResourceManager::GetShader("postprocessing");
    Effects = new PostProcessor(myppShader, this->Width, this->Height);
    // load levels
...
void Game::Render()
{
    if (this->State == GAME_ACTIVE)
    {
        ...
        Renderer->DrawSprite(tex, glm::vec2(0.0f, 0.0f), glm::vec2(this->Width, this->Height), 0.0f);
        // draw level
